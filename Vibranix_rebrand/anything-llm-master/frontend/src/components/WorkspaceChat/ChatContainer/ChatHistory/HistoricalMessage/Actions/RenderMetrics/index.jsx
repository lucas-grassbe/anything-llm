...
const SHOW_METRICS_KEY = "vibranix_show_chat_metrics";
const SHOW_METRICS_EVENT = "vibranix_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `vibranix_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `vibranix_show_chat_metrics` key
 * @returns {void}
 */
