...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Vibranix",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "Vibranix Embedder",
    description: [
      "Your document text is embedded privately on this instance of Vibranix",
    ],
    logo: null,
  },
  openai: {
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in Vibranix`,
    ],
    logo: null,
  }),
  EMBEDDING: (provider) => ({
      ...
      <div className="p-8 flex flex-col gap-8">
        <div className="flex flex-col gap-y-2 border-b border-theme-sidebar-border pb-4">
          ...
          <div className="flex items-center gap-2.5">
            <img
              src={LLMSelection.logo || instanceLogo}
              alt="LLM Logo"
        ...
        <div className="flex flex-col gap-y-2 border-b border-theme-sidebar-border pb-4">
          ...
          <div className="flex items-center gap-2.5">
            <img
              src={EmbeddingEngine.logo || instanceLogo}
              alt="LLM Logo"
              className="w-8 h-8 rounded"
            />
            <p className="text-theme-text-primary text-sm font-bold">
        ...
        <div className="flex flex-col gap-y-2 pb-4">
          ...
          <div className="flex items-center gap-2.5">
            <img
              src={VectorDb.logo || instanceLogo}
              alt="LLM Logo"
              className="w-8 h-8 rounded"
            />
            <p className="text-theme-text-primary text-sm font-bold">
