...
export const ONBOARDING_SURVEY_URL = "https://onboarding.vibranix.com";

export const AUTH_USER = "vibranix_user";
export const AUTH_TOKEN = "vibranix_authToken";
export const AUTH_TIMESTAMP = "vibranix_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "vibranix_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "vibranix_pinned_document_alert";
export const SEEN_WATCH_ALERT = "vibranix_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "vibranix_last_visited_workspace";

export const APPEARANCE_SETTINGS = "vibranix_appearance_settings";
